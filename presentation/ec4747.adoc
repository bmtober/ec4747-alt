...
$ A = (m_00 + m_11)/(m_00 + m_01 + m_10 + m_11) $

where 

$m_00$ is the number of messages actually spam and identified as spam (i.e, correct) 

$m_01$ is the number of messages actually spam but identified as ham of (i.e., error)

$m_10$ is the number of messages actually ham but identified as spam (i.e., error)

$m_11$ is the number of messages actually ham and identified as ham (i.e., correct)

== Math

Cosine similarity is defined as the normalized dot product
